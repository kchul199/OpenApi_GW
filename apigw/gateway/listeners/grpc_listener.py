...
class GRPCGatewayServer:
    ...
    def __init__(
        ...
        self._proxy = GenericGRPCProxy(router, gateway_config_provider)
    ...
    async def start(self) -> None:
        ...
        self._server.add_generic_rpc_handlers((self._proxy,))
...
async def run_grpc_server(
    ...
    server = GRPCGatewayServer(router, gateway_config_provider, host, port)
    await server.start()
    await server.serve()
